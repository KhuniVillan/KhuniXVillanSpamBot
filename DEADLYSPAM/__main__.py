...
from KHUNISPAM.utils import load_plugins
import logging
...
Khuni = "🎉 Successfully Deployed Khuni SpamBot 🎉 @Khuni_X_Villan_Support_Group Enjoy! Do visit @Khuni_X_Villan_Support_Group"
print(deadly[0: ])
