import config
from KHUNISPAM import BOT0, SUDOERS
...
HELP_PIC = "https://graph.org/file/a1485c66e31dfeb995bf6.jpg"

DEAD_HELP = "🔥 KHUNI Sᴘᴀᴍ Bᴏᴛ 🔥\n\n"
 
DEAD_HELP += f"__ᴄᴍɴᴅs ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ KHUNI ʙᴏᴛ__\n\n"
...
DEAD_HELP += f"© @Khuni_X_Villan_Support_Group\n"


@BOT0.on(events.NewMessage(incoming=True, pattern='/help'))
async def help(event):               
    if event.sender_id in SUDOERS:
       blaze = [[Button.url("ᴄʜᴀɴɴᴇʟ", "https://t.me/Khuni_X_Villan_Support_Group"), Button.url("sᴜᴘᴘᴏʀᴛ", "https://t.me/Khuni_X_Villan_Support_Group")]]
